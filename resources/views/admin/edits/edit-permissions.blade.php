@extends('layouts.default')
    ...
    @section('meta')
        <title>Edition Permissions | KKS-Presence</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">{{ __("Modifier les autorisations ") }}
                    <a href="{{ url('users/roles') }}" class="ui basic blue button mini offsettop5 float-right"><i class="ui icon chevron left"></i>{{ __("Retour") }}</a>
                </h2>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="box box-success">
                    ...
                    <div class="box-footer">
                        ...
                        <button class="ui positive approve small button" type="submit" name="submit"><i class="ui checkmark icon"></i>{{ __("Valider") }}</button>
                        <a href="{{ url('users/roles') }}" class="ui grey cancel small button"><i class="ui times icon"></i>{{ __("Annuler") }}</a>
                    </div>
                    </form>
                </div>
            </div>
