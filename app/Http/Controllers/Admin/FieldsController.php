...
class FieldsController extends Controller
{
    ...
    */
    ...
    public function addCompany(Request $request)
    {
      ...
      return redirect('fields/company')->with('success', trans("Une nouvelle entreprise a été ajoutée !"));
    }
    ...
    public function deleteCompany($id, Request $request)
    {
      ...
      return redirect('fields/company')->with('success', trans("Supprimé !"));
    }
    ...
    */
    ...
    public function addDepartment(Request $request)
    {
      ...
      return redirect('fields/department')->with('success', trans("Un nouveau département a été ajouté !"));
    }
    ...
    public function deleteDepartment($id, Request $request)
    {
      ...
      return redirect('fields/department')->with('success', trans("Supprimé !"));
    }
    ...
    */
    ...
    public function addJobtitle(Request $request)
    {
      ...
      return redirect('fields/jobtitle')->with('success', trans("Un nouveau titre de poste a été ajouté !"));
    }
    ...
    public function deleteJobtitle($id, Request $request)
    {
      ...
      return redirect('fields/jobtitle')->with('success', trans("Supprimé !"));
    }
    ...
    */
    ...
    public function addLeavetype(Request $request)
    {
      ...
      return redirect('fields/leavetype')->with('success', trans("Un nouveau groupe de congés a été ajouté !"));
    }
    ...
    public function deleteLeavetype($id, Request $request)
    {
      ...
      return redirect('fields/leavetype')->with('success', trans("Supprimé !"));
    }
    ...
    */
    ...
    public function addLeaveGroups(Request $request) 
    {
      ...
      return redirect('fields/leavetype/leave-groups')->with('success', trans("Un nouveau groupe de congés a été ajouté !"));
    }
    ...
    public function deleteLeaveGroups($id,Request $request) 
    {
      ...
      return redirect('fields/leavetype/leave-groups')->with('success', trans("Supprimé !"));
    }
} 