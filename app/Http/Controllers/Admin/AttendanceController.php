...
class AttendanceController extends Controller
{
    ...
    public function delete($id, Request $request)
    {
        ...
        return redirect('attendance')->with('success', trans("Supprimé !"));
    }
    ...
    public function update(Request $request)
    {
        ...
        if($sched_out_time == null) 
        {
            ...
            {
                $status_out = 'Horaire respecté';
            } else {
                $status_out = 'Départ précoce';
            }
        }
        ...
        return redirect('attendance')->with('success', trans("Le pointage des employés a été mise à jour!"));
    }
    ...
    public function addEntry(Request $request)
    {
        ...
        if ($request->ref == NULL) {
            return redirect('attendance')->with('error', trans("Veuillez remplir complètement le formulaire."));
        }
        ...
        if ($iprestriction != NULL) 
        {
            ...
            {
                return redirect('attendance')->with('error', trans("Oups! Vous n'êtes pas autorisé à pointer à l'arrivée ou à la sortie à partir de votre adresse IP")." ".$ip);
            }
        } 
        ...
        if($emp_id == null || $emp_idno == null) {
            return redirect('attendance')->with('error', trans("Cet Employé est introuvable."));
        }
        ...
        if ($timeout == null) 
        {
            ...
            if ($has == 1) 
            {
                ...
                return redirect('attendance')->with('error', trans("Cet Employé à déjà pointer son arrivée à -")." ".$hti_24);
                ...
                return redirect('attendance')->with('success', trans("Le pointage de cet Employé a bien été ajouté !"));
            }
        }
        ...
        if ($timeout != null && $timein != null) 
        {
            ...
            if ($has == 1) 
            {
                ...
                return redirect('attendance')->with('success', trans("La présence des employés a été ajoutée !"));
            }
        }
    }
