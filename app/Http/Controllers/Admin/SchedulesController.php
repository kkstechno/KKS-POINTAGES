...
class SchedulesController extends Controller
{
    ...
    public function add(Request $request) 
    {
        ...
        $intime = date("H:i:s", strtotime($request->intime)) ;
        $outime = date("h:i:s", strtotime($request->outime)) ;
        ...
        if ($ref == 1) 
        {
            return redirect('schedules')->with('error', trans("Désolé! Cet employé a déjà un horaire. Veuillez archiver l'horaire actuel pour ajouter un nouvel horaire."));
        }
    	...
    	return redirect('schedules')->with('success', trans("Nouvel horaire ajouté!"));
	}
    ...
    public function update(Request $request) 
    {
        ...
        $intime = date("H:i", strtotime($request->intime)) ;
        $outime = date("H:i", strtotime($request->outime)) ;
        $datefrom = $request->datefrom; 
        $dateto = $request->dateto; 
        $hours = $request->hours;
        ...
        return redirect('schedules')->with('success', trans("Horaire mis à jour !"));
    }
    ...
    public function delete($id, Request $request) 
    {
        ...
        return redirect('schedules')->with('success', trans("Données supprimées! "));
    }
    ...
    public function archive($id, Request $request)
    {
    	...
    	return redirect('schedules')->with('success', trans("Horaire archivé !"));
   	}
