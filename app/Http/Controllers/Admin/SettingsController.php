...
class SettingsController extends Controller
{
    ...
    public function update(Request $request) 
    {
        ...
        return redirect('settings')->with('success', trans("Les paramètres sont à jour. Veuillez essayer de vous reconnecter pour que les nouveaux paramètres prennent effet."));
    }
