...
class EmployeesController extends Controller
{
    ...
    public function add(Request $request)
    {
		...
		if ($is_idno_taken == 1) 
		{
			return redirect('employees-new')->with('error', trans("Oups! le numéro d'identification est déjà pris."));
		}
    	...
    	return redirect('employees')->with('success', trans("Un nouvel employé a été ajouté!"));
    }
}
?>
