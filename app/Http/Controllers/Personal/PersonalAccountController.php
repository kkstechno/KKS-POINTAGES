...
class PersonalAccountController extends Controller
{
    ...
    public function updateUser(Request $request) 
    {
        ...
        if($id == null) 
        {
            return redirect('personal/update-user')->with('error', trans("Oups! Veuillez remplir complètement le formulaire."));
        }
        ...
        return redirect('personal/update-user')->with('success', trans("Le compte utilisateur a été mis à jour!"));
    }
    ...
    public function updatePassword(Request $request) 
    {
        ...
        {
            return redirect('personal/update-password')->with('error', trans("Le nouveau mot de passe ne correspond pas."));
        }
        ...
        if(Hash::check($c_password, $p)) 
        {
            ...
            return redirect('personal/update-password')->with('success', trans("Le mot de passe utilisateur a été mis à jour!"));
        } else {
            return redirect('personal/update-password')->with('error', trans("Oops! le mot de passe actuel ne correspond pas."));
        }
    }
}
